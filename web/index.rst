...
webové mapové frameworky - :doc:`leaflet` a :doc:`openlayers`. Na
příkladu OpenLayers si také ukážeme možnost :doc:`editace
<openlayers-wfst>` prvků a zapsání změn na serveru pomocí protokolu
OGC WFS-T (*Transactional WFS*).
